...
to turtle-setup ;; turtle procedure
  ...
  set sugar random-in-range 5 max-sugar
...
<experiments>
  ...
  <experiment name="metabolism" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>count turtles</metric>
    ...
    <steppedValueSet variable="max-metabolism" first="1" step="1" last="10"/>
    <enumeratedValueSet variable="max-vision">
      <value value="6"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="vision-meta" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="800"/>
    <metric>count turtles</metric>
    ...
    <steppedValueSet variable="max-metabolism" first="1" step="1" last="10"/>
    <steppedValueSet variable="max-vision" first="1" step="1" last="10"/>
  </experiment>
  <experiment name="popu-vision" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="800"/>
    <metric>count turtles</metric>
  ...
  <experiment name="popu-meta" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="800"/>
    <metric>mean [metabolism] of turtles</metric>
    <enumeratedValueSet variable="max-sugar">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="visualization">
      <value value="&quot;no-visualization&quot;"/>
